      ...
      <div className="desc">
        ...
        <Row>
          <Col span={8}>
            ...
            <img src="https://oss.genial.ltd/a8cfd/2e957eb8c030fc2d10de5607715f4c55.svg" className="expImg" alt=""></img>
            <p className="expText">告诉Genial你的背景、目标和兴趣</p>
          </Col>
          <Col span={8}>
            {/* <img src={Step2} className="expImg" alt=""></img> */}
            <img src="https://oss.genial.ltd/a8cfd/9b782e40768fc9007786b032ba7911aa.svg" className="expImg" alt=""></img>
            <p className="expText">每周选择：你是否想进行新的匹配</p>
          </Col>
          <Col span={8}>
            <img src="https://oss.genial.ltd/a8cfd/36129a68e34a0c182d4e7ad279e7bd86.svg" className="expImg" alt=""></img>
